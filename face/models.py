...
class UserOfApp(AbstractUser):
    ...
    photo = models.CharField(max_length=500, default='face_db/9Aditya_Chavan_Photo.jpg')
    spotify_uid = models.CharField(max_length=500, default='joab4qf54hmmc19t23jmj7i1h')
    temperature_preference = models.CharField(max_length=500, default='24')
