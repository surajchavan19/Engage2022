...
def signupsubmit(request):
    ...
    temperature_preference = request.POST['temperature_preference']
    profile_pic = request.FILES['file']
    fs = FileSystemStorage()
    user = UserOfApp.objects.create_user(first_name = first_name, last_name = last_name, username = username, password = password, spotify_uid=spotify_uid, temperature_preference=temperature_preference)
...
def photodetect(request):
    ...
    if t[0]:
        ...
        'temperature_preference' : t[2].temperature_preference
        }
    else:
        print("not found")
